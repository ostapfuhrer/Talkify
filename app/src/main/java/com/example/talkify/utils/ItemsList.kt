...
val transports = List(21) { Item("${it + 21}", R.drawable::class.java.getDeclaredField("transport_${it}").getInt(null)) }
val emotions = List(16) { Item("${it + 42}", R.drawable::class.java.getDeclaredField("emotions_${it}").getInt(null)) }
